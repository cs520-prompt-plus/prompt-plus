...
BINARY_PATHS = model_parse(BinaryPaths, {'queryEngine': {'linux-musl-arm64-openssl-3.0.x': '/usr/local/lib/node_modules/prisma/query-engine-linux-musl-arm64-openssl-3.0.x', 'debian-openssl-3.0.x': '/usr/local/lib/node_modules/prisma/query-engine-debian-openssl-3.0.x'}, 'introspectionEngine': {}, 'migrationEngine': {}, 'libqueryEngine': {}, 'prismaFmt': {}})
...
class Prisma(AsyncBasePrisma):
    ...
    response: 'actions.ResponseActions[models.Response]'
    category: 'actions.CategoryActions[models.Category]'
    pattern: 'actions.PatternActions[models.Pattern]'
    ...
    def __init__(
        ...
        *,
        ...
        self.response = actions.ResponseActions[models.Response](self, models.Response)
        self.category = actions.CategoryActions[models.Category](self, models.Category)
        self.pattern = actions.PatternActions[models.Pattern](self, models.Pattern)
    ...
    def _default_datasource(self) -> Datasource:
        return {
            ...
            'source_file_path': '/app/schema.prisma',
        }
...
class Batch:
    ...
    response: 'ResponseBatchActions'
    category: 'CategoryBatchActions'
    pattern: 'PatternBatchActions'
    ...
    def __init__(self, client: Prisma) -> None:
        ...
        self.response = ResponseBatchActions(self)
        self.category = CategoryBatchActions(self)
        self.pattern = PatternBatchActions(self)
