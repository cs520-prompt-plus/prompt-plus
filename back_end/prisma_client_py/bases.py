...
class BaseResponse(_PrismaModel):
    __prisma_model__: ClassVar[Literal['Response']] = 'Response'  # pyright: ignore[reportIncompatibleVariableOverride]

    @classmethod
    def prisma(cls: Type[_PrismaModelT], client: Optional['Prisma'] = None) -> 'actions.ResponseActions[_PrismaModelT]':
        from .client import get_client

        return actions.ResponseActions[_PrismaModelT](client or get_client(), cls)
...
class BasePattern(_PrismaModel):
    __prisma_model__: ClassVar[Literal['Pattern']] = 'Pattern'  # pyright: ignore[reportIncompatibleVariableOverride]

    @classmethod
    def prisma(cls: Type[_PrismaModelT], client: Optional['Prisma'] = None) -> 'actions.PatternActions[_PrismaModelT]':
        from .client import get_client

        return actions.PatternActions[_PrismaModelT](client or get_client(), cls)
